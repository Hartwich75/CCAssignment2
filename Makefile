...
run:	main.class
	java $(classpathoption) main 01-hello-world.hw > 01.txt
	java $(classpathoption) main 01b-hello-world-withdef.hw  > 01b.txt
	java $(classpathoption) main 02-trafiklys-minimal.hw  > 02.txt
	java $(classpathoption) main 03-trafiklys.hw  > 03.txt
	java $(classpathoption) main 04-von-Neumann.hw  > 04.txt

grun:	hwLexer.class hwParser.class 01-hello-world.hw
	$(grun) impl start -gui -tokens 01-hello-world.hw

clean:
	rm $(GENERATED) *.class hw.interp hwLexer.interp hwLexer.tokens hw.tokens *.txt
